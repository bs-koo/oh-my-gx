...
저장 후 사용자에게 다음 단계를 안내한다.

```
작업 계획을 .dev/plan.md에 저장했습니다.

  /gx-tdd --work W00    으로 첫 작업을 시작할 수 있습니다.
  W01·W02·W03은 W00 완료 후 동시에 진행할 수 있습니다.

이 파일은 저장소에 공유되므로 팀원이 git pull 후 같은 계획을 봅니다.
```
