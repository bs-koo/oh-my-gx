...
- **예산 린트**: SKILL.md ≤ 58,000B, phase-setup.md ≤ 22,000B를 정합성 린트로 고정한다. 45KB 목표는 인자 절(의도 파싱 6K자) 재작성이 필요해 후속으로 남긴다.
...
| 오케스트레이터 지시문 (기본 경로) | 약 246KB | 약 210KB (SKILL 58KB + setup 22KB, 나머지 동일) |
